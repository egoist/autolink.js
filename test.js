...
describe('main', () => {
  it('replace only url', done => {
    const string = 'url http://github.com/egoist ok, image http://twitter.com/shomin_sample.jpg no'
    const result = 'url <a href="http://github.com/egoist">http://github.com/egoist</a>  ok, image <a href="http://twitter.com/shomin_sample.jpg">http://twitter.com/shomin_sample.jpg</a>  no'
  ...
  it('replace url and image', done => {
    ...
    const result = 'url <a href="http://github.com/egoist">http://github.com/egoist</a>  ok, image<img src="http://twitter.com/shomin_sample.jpg"/> too'
